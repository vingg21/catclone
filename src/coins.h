...
/** 
    ...
    ****Note - for CATSCOIN we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of catscoin coming in to a transaction
