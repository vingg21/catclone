// Copyright (c) 2017-2018 The CATSCOIN developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CATSCOIN_ZCATSWALLET_H
#define CATSCOIN_ZCATSWALLET_H
...
public:
    CzCATSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCATS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCATS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
