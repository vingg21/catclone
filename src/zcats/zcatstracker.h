...
#ifndef CATSCOIN_ZCATSTRACKER_H
#define CATSCOIN_ZCATSTRACKER_H
...
public:
    CzCATSTracker(std::string strWalletFile);
    ~CzCATSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCATSWallet* zCATSWallet = NULL);
