...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop CATSCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "CATSCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CATSCOIN features */
        {"catscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"catscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"catscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"catscoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"catscoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"catscoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"catscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"catscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"catscoin", "startmasternode", &startmasternode, true, true, false},
        {"catscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"catscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"catscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"catscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"catscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"catscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"catscoin", "preparebudget", &preparebudget, true, true, false},
        {"catscoin", "submitbudget", &submitbudget, true, true, false},
        {"catscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"catscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"catscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"catscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"catscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"catscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"catscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"catscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"catscoin", "mnsync", &mnsync, true, true, false},
        {"catscoin", "spork", &spork, true, true, false},
        {"catscoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> catscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33124/\n";
}
