...
/** Utility functions used by the CATSCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render CATSCOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZcats = false);
...
// Parse "catscoin:" URI into recipient object, return true on successful parsing
