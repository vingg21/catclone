...
#include "qt/catscoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/catscoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CATSCOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CATSCOINGUI::handleRestart()
