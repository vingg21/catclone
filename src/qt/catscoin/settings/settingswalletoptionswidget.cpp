...
#include "qt/catscoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/catscoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(CATSCOINGUI* _window, QWidget *parent) :
