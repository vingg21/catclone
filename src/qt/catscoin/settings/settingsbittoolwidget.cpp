...
#include "qt/catscoin/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(CATSCOINGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsBitToolWidget)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("Enter a CATSCOIN address"));
...
void SettingsBitToolWidget::importAddressFromDecKey(){
    ...
    ui->statusLabel_DEC->setText(tr("Successfully added catsate key to the wallet"));
}
