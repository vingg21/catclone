...
#include "qt/catscoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/catscoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(CATSCOINGUI* _window, QWidget *parent) :
