...
#include "qt/catscoin/coincontrolcatswidget.h"
#include "qt/catscoin/forms/ui_coincontrolcatswidget.h"

CoinControlCatsWidget::CoinControlCatsWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlCatsWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select CATS Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("CATS");
    ...
    ui->labelValueAfter->setText("0.00 CATS");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 CATS");
    ui->labelValueFee->setText("0.00 CATS");
...
CoinControlCatsWidget::~CoinControlCatsWidget()
{
    delete ui;
}
