...
#include "qt/catscoin/forms/ui_masternodeswidget.h"
#include "qt/catscoin/qtutils.h"
#include "qt/catscoin/mnrow.h"
#include "qt/catscoin/mninfodialog.h"

#include "qt/catscoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(CATSCOINGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:33123 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
