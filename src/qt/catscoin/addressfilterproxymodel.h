...
#ifndef CATSCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define CATSCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //CATSCOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
