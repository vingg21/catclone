...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, CATSCOINGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, CATSCOINGUI *gui, double posX = 3);
