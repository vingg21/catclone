...
#include "config/catscoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalCats = 0;
    qint64 totalZcats = 0;
    QList<qreal> valuesCats;
    QList<qreal> valueszCats;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(CATSCOINGUI* _window);
    ~DashboardWidget();
