...
#include "qt/catscoin/forms/ui_coldstakingwidget.h"
#include "qt/catscoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/catscoin/requestdialog.h"
#include "qt/catscoin/tooltipmenu.h"
#include "qt/catscoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(CATSCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your CATSs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept CATS delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select CATS outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 CATS" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
