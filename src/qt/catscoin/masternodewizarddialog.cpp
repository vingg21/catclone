...
#include "qt/catscoin/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 33123");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("33129");
    } else {
        ui->lineEditPort->setText("33123");
    }
