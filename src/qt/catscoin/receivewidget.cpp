...
#include "qt/catscoin/forms/ui_receivewidget.h"
...
#include "qt/catscoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(CATSCOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive CATS."));
