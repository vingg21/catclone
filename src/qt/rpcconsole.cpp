                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCATSPathCustom = GetArg("-zcatsbackuppath", "");
    ...
    if(!strzCATSPathCustom.empty()) {
        ui->wallet_customzcatsbackuppath->setText(QString::fromStdString(strzCATSPathCustom));
        ui->wallet_customzcatsbackuppath_label->setVisible(true);
        ui->wallet_customzcatsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCATSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CATSCOIN RPC console.") + "<br>" +
