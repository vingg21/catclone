...
#ifndef CATSCOIN_QT_WALLETMODEL_H
#define CATSCOIN_QT_WALLETMODEL_H
...
/** Interface to CATSCOIN wallet from Qt view code. */
...
#endif // CATSCOIN_QT_WALLETMODEL_H
