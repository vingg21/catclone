 ...
 * CATSCOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    int CATScoinBadBlockTime() const { return nCATScoinBadBlockTime; }
    int CATScoinBadBlocknBits() const { return nCATScoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nCATScoinBadBlockTime;
    unsigned int nCATScoinBadBlocknBits;
