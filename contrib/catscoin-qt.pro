...
RESOURCES += src/qt/catscoin.qrc src/qt/catscoin_locale.qrc

TRANSLATIONS += src/qt/locale/catscoin_bg.ts \
                src/qt/locale/catscoin_de.ts \
                src/qt/locale/catscoin_en.ts \
                src/qt/locale/catscoin_es.ts \
                src/qt/locale/catscoin_fi.ts \
                src/qt/locale/catscoin_fr.ts \
                src/qt/locale/catscoin_it.ts \
                src/qt/locale/catscoin_ja.ts \
                src/qt/locale/catscoin_pl.ts \
                src/qt/locale/catscoin_pt.ts \
                src/qt/locale/catscoin_ru.ts \
                src/qt/locale/catscoin_sk.ts \
                src/qt/locale/catscoin_sv.ts \
                src/qt/locale/catscoin_vi.ts \
                src/qt/locale/catscoin_zh_CN.ts \
                src/qt/locale/catscoin_zh_TW.ts
