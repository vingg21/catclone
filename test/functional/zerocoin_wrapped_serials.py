...
from fake_stake.base_test import CATSCOIN_FakeStakeTest

class zCATSwrappedSerialsTest(CATSCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zCATSs..." % DENOM_TO_USE)
