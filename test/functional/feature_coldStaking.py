...
from test_framework.catscoin_node import CATScoinTestNode
...
class CATSCOIN_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(CATScoinTestNode())
