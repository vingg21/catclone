...
The script [extract-osx-sdk.sh](https://github.com/CATScoin/catscoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
catscoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/CATScoin/catscoin/blob/master/doc/README_osx.md) for troubleshooting tips.